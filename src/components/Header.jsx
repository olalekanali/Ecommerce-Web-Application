        ...
        <div className="px-4 flexBetween py-3 max-xs:px-2">
            ...
            <div className="flexBetween sm:gap-x-2 bold-16">
              ...
              <div className="flexBetween sm:gap-x-6">
                <NavLink to="/cart-page" className={"flex"}><FaOpencart className="p-2 h-8 w-8 ring-slate-900/30 ring-1 rounded-full"/>
                <span className="relative w-5 h-5 flexCenter rounded-full bg-secondary text-white medium-14 -top-2">0</span>
                </NavLink>
